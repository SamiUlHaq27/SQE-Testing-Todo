...
WebUI.click(findTestObject('Page_Todo list app/button_Unmark All'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Todo list app/ul_Task 2Task 1'), 0)
